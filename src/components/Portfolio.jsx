...
import dash from "../assets/dashan.png";
...
const Portfolio = () => {
  const portfolios = [
    ...
    },
    {
      id: 4,
      src: walletTracker,
      demo: "https://solana-wallet-tracker.vercel.app/",
      code: "https://github.com/0xraidr/solana-wallet-tracker",
    },
    {
      id: 5,
      src: dash,
      demo: "anon-dash.vercel.app",
      code: "https://github.com/0xraidr/anon-dash",
    },
    {
      id: 6,
      src: spaceinvaders,
      demo: "https://github.com/0xraidr/space-invaders",
      code: "https://github.com/0xraidr/space-invaders",
    },
  ];
  ...
  return (
    <div
      name="portfolio"
      className="bg-gradient-to-b from-black to to-slate-800
